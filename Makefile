...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/11/02 09:41:16 by abarchil          #+#    #+#              #
#    Updated: 2021/11/10 23:06:48 by abarchil         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILE = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
		...
		ft_substr.c ft_tolower.c ft_toupper.c ft_printf.c ft_printf_convert_utils.c\
		ft_printf_put_utils.c ft_printf_utils.c ft_chose_convert.c ft_convert_option.c\
